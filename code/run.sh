TIMELIMIT=3600			# time limit for a method (MINLP or Heuristic)
NUM_ID_PER_BATCH=2		# the number of instances in a batch. If you run multiple methods, then it runs "NUM_ID_PER_BATCH x NUM_METHODS" per batch. 
